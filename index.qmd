...
::: {.column width="40%"}
- QuartoはRやPythonの計算結果を直接文章に入れるツールです。
  - HTML（ウェブサイト、スライド、本）
  - PDF
  - MS Word
:::
...
[Image: [Allison Horst](https://allisonhorst.com/allison-horst)]{.medsmall}
:::
...
::: {.column width="50%"}
- しかし、Quartoは比較的新しいため、まだ欠けている機能があります。
...
::: {.column width="50%"}
- [@maelle](https://github.com/maelle)によるQuarto BookやWebsiteの**各言語**のバージョンを**レンダーする** Rパッケージ。
